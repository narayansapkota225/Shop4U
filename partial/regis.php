...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand logo" href="../index.php"><img src="./images/Shop4U-logo.png" class="img-thumbnail-responsive" width="151" height="94"></img></a>
    ...
    <form class="d-flex justify-content-end">
          <a href="../signup.php"><button class="btn btn-lg btn-outline-secondary" type="button">Sign Up</button></a>
          <a class="navbar-brand" href="#"></a>
          <a href="../login.php"><button class="btn btn-lg btn-outline-success me-2" type="button">Login</button></a>
        </form>
    </div>
  </div>
</nav>