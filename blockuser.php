...
?>
<?php $Title = "Block User | Admin - Shop4U"?>
            ...
            <div class="" style="margin-top:40px">
                <div class="rounded d-flex justify-content-center">
                    <div class="col-md-4 col-sm-12 shadow-lg p-3 bg-light">
                        ...
                        <form action="../db/blockuserconfig.php" method="POST">
                            <div class="p-4">
                                <div class="container">
                                    <p class="text-center"><strong>Are you sure you want to blocked <?php echo ("$fname $lname");?></strong></p>
