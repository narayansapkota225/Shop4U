            ...
            <div class="" style="margin-top:40px">
                <div class="rounded d-flex justify-content-center">
                    <div class="col-md-4 col-sm-12 shadow-lg p-3 bg-light">
                        ...
                        <form action="../db/deleteproconfig.php" method="POST">
                            <div class="p-4">
                                <div class="container">
                                    <p class="text-center fs-2"><strong>Are you sure you want to delete <u>"<?php echo ("$title");?>"</u></strong></p>
                                    <p class="text-center fs-2"><img src="../images/product/<?php echo $image;?>" width="250px"></p>
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="invalidCheck">
                                        ...
                                        <strong>DELETE</strong> this Product <strong>PERMENANTLY</strong>.
                                        This Product will be delete and remove from the database.
                                    </label>
                                </div>
                                <div class="d-flex justify-content-evenly">
                                    <button class="btn btn-danger text-start mt-2 " type="submit">Yes</button>
                                    <a href="product.php"><button class="btn btn-dark text-end mt-2" type="button">Cancel</button></a>
                                </div>
                            </div>
                        </form>
                    </div>
